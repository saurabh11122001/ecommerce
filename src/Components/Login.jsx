...
const Login = () => {
    ...
    const {setLogin,register,setRegister,setLoader,setUser,user,userDetials}=context;
    ...
    {!register?<div  className='login bg-black bg-opacity-70 flex items-center justify-center absolute top-0 w-screen h-screen'>
            <div className='bg-gray-100 login-child h-5/6 flex flex-col gap-2 justify-center items-center  w-2/6 rounded-md py-1 px-1'>
              ...
              <div className=' h-full w-5/6 flex flex-col gap-2 items-center justify-center'>
                  <div className='px-2 h-20 w-full flex gap-2 items-center justify-between'><span className='font-medium text-xl'>Username</span><input className='h-10 w-5/6 rounded-lg text-xl outline-none px-2' type="text" value={credentials.username}name='username'onChange={onChange}/></div>
                  <div className='px-2 h-20 w-full flex gap-2 items-center justify-between'><span className='font-medium text-xl'>Password</span><input className='h-10 w-5/6 rounded-lg text-xl outline-none px-2' type="password"value={credentials.password}name='password'onChange={onChange} /></div>
                  <div className=' h-28 w-full flex flex-col gap-5 justify-center items-center py-2'>
                    <h1 className='bg-blue-800 h-10 w-28 py-2 rounded-lg text-white cursor-pointer text-center'onClick={login}>Login</h1>
